    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.PositiveIntegerField(default=1000)),
                ('pgdump_file', models.FileField(storage=tablemanager.models.DownloadFileSystemStorage(), upload_to=tablemanager.models.get_full_data_file_name, null=True, editable=False)),
                ('style_file', models.FileField(storage=tablemanager.models.DownloadFileSystemStorage(), upload_to=tablemanager.models.get_full_data_file_name, null=True, editable=False)),
